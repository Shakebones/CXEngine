/*--------------------------------------------------------------------------
 * File name - GEFFTOceanSurface.cpp
 * Author - CuiXue
 * Updated date - 2015.2.12
 * Desc - 
 *
 *--------------------------------------------------------------------------*/
#include "GEFFTOceanSurface.h"

CGEFFTOceanSurface::CGEFFTOceanSurface()
{
...
CGEFFTOceanSurface::CGEFFTOceanSurface(const CGEFFTOceanSurface& source)
{

}

CGEFFTOceanSurface& CGEFFTOceanSurface::operator=(const CGEFFTOceanSurface& source)
{
	return *this;
}
...
bool CGEFFTOceanSurface::Initialize(ID3D11Device* pDevice, HWND hWnd)
{
	bool result;
...
void CGEFFTOceanSurface::Shutdown()
{
	this->_shutdown();
}

bool CGEFFTOceanSurface::SetParams(/* Params list */)
{
	bool result;
...
bool CGEFFTOceanSurface::Render(ID3D11DeviceContext* pDeviceContext, int indexCount)
{
	bool result;
 ...
 *
 *--------------------------------------------------------------------------*/
bool CGEFFTOceanSurface::_initialize_shaders(ID3D11Device* pDevice, HWND hWnd, WCHAR* vsFilename, WCHAR* psFilename /* May need more other shaders like hull shader*/)
{
...
void CGEFFTOceanSurface::_shutdown()
{
...
void CGEFFTOceanSurface::_output_error_message(ID3D10Blob* pErrorMessage, HWND hWnd, WCHAR* pShaderFilename)
{
...
bool CGEFFTOceanSurface::_set_shader_params(/* Params list */)
{
	return true;
}

bool CGEFFTOceanSurface::_render(ID3D11DeviceContext* pDeviceContext, int indexCount)
{
